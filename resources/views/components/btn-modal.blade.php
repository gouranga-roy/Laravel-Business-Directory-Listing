@props(['title', 'dataTitle', 'url', 'size', 'icon', 'class'])

<button type="button" data-modal="modal" data-url="{{ $url }}" data-title="{{ translate($dataTitle ?? $title) }}" @isset($size) data-size="{{ $size }}" @endisset
